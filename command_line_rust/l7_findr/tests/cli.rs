...
// Use std::borrow::Cow means that on Unix systems the string is not cloned,
// and on Windows, the modified filename is returned as an owned string
#[cfg(not(windows))]
fn format_file_name(expected_file: &str) -> Cow<str> {
